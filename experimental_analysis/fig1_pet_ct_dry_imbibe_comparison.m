...
% COLORBREWER IS REQUIRED FOR MANUSCRIPT COLORMAPS 
...
% Colormaps using matlab defaults
sat_blue = cool(70);
white_jet = flipud(hot(120));


% plot PET data first
load('SI_concat_PET_4D_22x22')
comp_PET_4D_coarse = SI_concat_PET_4D(:,:,1:41,:)./0.32;
% a = squeeze(nansum(nansum(nansum(comp_PET_4D_coarse))));
% plot([1:120], a)
